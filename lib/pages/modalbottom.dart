...
void showTabModal(BuildContext context, String guestName, String guestCode,
  ...
  showModalBottomSheet(
    ...
    builder: (context) {
      ...
      BuildContext contextnya = context;
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                              ...
                              children: [
                                ...
                                TeksBiasa(
                                    "tanpa gambaran akan ke mana", context),
                                const SizedBox(height: 20),
                                TeksBiasa("Doa-doa meramu harapan,", context),
                                TeksBiasaBold(
                                    "menuntun arah untuk saling menemukan",
                                    context),
                                const SizedBox(height: 20),
                                ...
                                TeksBiasaBold(
                                    ...
                                    context),
                                TeksBiasa("mengakhiri perjalanan dan pencarian",
                                    context),
                                const SizedBox(height: 20),
                                TeksBiasa(
                                    "Kita akan usai dengan segala tanya dan keraguan,",
                                    context),
                                TeksBiasa(
                                    "menyambut garis selesai dari lamanya penantian",
                                    context),
                                const SizedBox(height: 20),
                                TeksBiasa("Bagaikan tawa yang tak pernah usai,",
                                    context),
                                TeksBiasa(
                                    "Semoga kelak dirasakan juga bagi mereka",
                                    context),
                                TeksBiasaBold(
                                    "yang sedang berusaha menuju garis selesai.",
                                    context),
                                const SizedBox(height: 20),
                                TeksBiasa("Semoga lelahmu hari ini", context),
                                TeksBiasaBold(
                                    "adalah pijakan menuju halal mu esok hari.",
                                    context),
                                const SizedBox(height: 20),
                                TeksBiasa("Semoga yang kau jaga dalam diam,",
                                    context),
                                TeksBiasaBold(
                                    "suatu saat kembali padamu dengan tenang.",
                                    context),
                                const SizedBox(height: 20),
                                TeksBiasa(
                                    "Karena cinta yang diperjuangkan dengan sabar,",
                                    context),
                                ...
                                const SizedBox(height: 40),
                                TeksBiasa(
                                    "Kirim Hadiah ke pengantin.", context),
                                const SizedBox(height: 20),
                                Image.asset(
                                  'assets/weddingassets/muamalat.png',
                                  fit: BoxFit.contain,
                                  height: 80,
                                ),
                                const SizedBox(height: 10),
                                TeksBiasa(
                                    "Bank Muamalat an IVAN RIFKI NUR ALIF",
                                    context),
                                const SizedBox(height: 10),
                                TextButton.icon(
                                  onPressed: () async {
                                ...
                                const SizedBox(height: 20),
                                Image.asset(
                                  'assets/weddingassets/bsi.png',
                                  fit: BoxFit.contain,
                                  height: 80,
                                ),
                                const SizedBox(height: 10),
                                TeksBiasa(
                                    "Bank BSI an IVAN RIFKI NUR ALIF", context),
                                const SizedBox(height: 10),
                                TextButton.icon(
                                  onPressed: () async {
                                    await Clipboard.setData(
                                ...
                                const SizedBox(height: 20),
                                Image.asset(
                                  'assets/weddingassets/bri.png',
                                  fit: BoxFit.contain,
                                  height: 80,
                                ),
                                const SizedBox(height: 10),
                                TeksBiasa(
                                    "Bank BRI an IVAN RIFKI NUR ALIF", context),
                                const SizedBox(height: 10),
                                TextButton.icon(
                                  onPressed: () async {
                                    await Clipboard.setData(
